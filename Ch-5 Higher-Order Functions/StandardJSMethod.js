/**
 * Describe FOREACH.
 * @param {array|object} array - array of numbers . 
 * @param {function} action - Any Function  
 */ 
// Whats actually going on in forEach
...
let numbers = [1, 2, 3, 4, 5], sum = 0, mul = 1;
...
// forEach is Standard method of array.
...
// Filtering an Array 
// To ﬁnd the people in the ancestry data set who were young in 1924, the following function might be helpful. It ﬁlters out the elements in an array that don’t pass a test.
...
// Filter is also standard method of array.


// Transforming with MAP
const map = (array, test) => {
  let newArray = [];
  array.forEach((element) => {
    newArray.push(test(element));    
  });
  return newArray;
}

// Like forEach and filter, map is also standard method of array.
...
let min = [100,2,30,4,15,6][0];
[100,2,30,4,15,6].forEach((cur) => {
  if (cur < min) {
    min = cur;
  }
});
