...
true or false. Just like && returns a true value only when the expressions
...
predicate returns true for any of the elements. They do not process more elements
than necessary—for example, if some finds that the predicate holds
