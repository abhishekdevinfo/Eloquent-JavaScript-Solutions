...
const ageDiff = (eChild, eMother) => {
  ageDiffArray.push(eChild.born - eMother.born);
}

ancestry.forEach((eChild) => {
  ancestry.forEach((eMother) => {
    if (eChild.mother === eMother.name) {
       ageDiff(eChild, eMother);
    }
  });
});
